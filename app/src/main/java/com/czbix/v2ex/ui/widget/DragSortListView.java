...
public class DragSortListView extends ListView {
    ...
    private void swapElements(List list, int indexOne, int indexTwo) {
        final Object temp = list.get(indexOne);
    ...
    public void setAdapter(ListAdapter adapter) {
        Preconditions.checkArgument(adapter instanceof StableArrayAdapter, "adapter must be StableArrayAdapter");
        Preconditions.checkState(mDataList != null, "must set data list");
